  ...
  <div id="app">
    <header class="header-global">
      <nav class="navbar navbar-main navbar-expand-lg navbar-light navbar-transparent">
        <div class="container">
          <a href="#/" class="navbar-brand mr-lg-5 router-link-active">
            <img src="img/brand/white.png" alt="logo" />
          </a>
          <button
            type="button"
            data-toggle="collapse"
            data-target="0.4132662763538051"
            aria-controls="0.4132662763538051"
            aria-label="Toggle navigation"
            class="navbar-toggler"
          >
            <span class="navbar-toggler-icon"></span>
          </button>
          <div id="0.4132662763538051" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
              ...
              <li aria-haspopup="true" class="dropdown nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <a href="#/landing" class="dropdown-item active router-link-active">Landing</a>
                ...
                <div class="row row-grid">
                  <div class="col-lg-4">
                    <div class="card border-0 card-lift--hover shadow">
                      ...
                      <div class="card-body py-5">
                        ...
                        <a type class="btn mt-4 btn-primary" href="#">
                          <!---->
                          <!---->
                          <!---->
                          Learn more
                  ...
                  <div class="col-lg-4">
                    <div class="card border-0 card-lift--hover shadow">
                      <!---->
                      <div class="card-body py-5">
                        <div class="icon icon-shape mb-4 icon-shape-success rounded-circle">
                        ...
                        <div>
                          <span class="badge badge-success badge-pill">business</span>
                          <span class="badge badge-success badge-pill">vision</span>
                          <span class="badge badge-success badge-pill">success</span>
                        </div>
                        <a type class="btn mt-4 btn-success" href="#">
                          <!---->
                          <!---->
                          <!---->
                          Learn more
                  ...
                  <div class="col-lg-4">
                    <div class="card border-0 card-lift--hover shadow">
                      <!---->
                      <div class="card-body py-5">
                        <div class="icon icon-shape mb-4 icon-shape-warning rounded-circle">
                        ...
                        <div>
                          <span class="badge badge-warning badge-pill">marketing</span>
                          <span class="badge badge-warning badge-pill">product</span>
                          <span class="badge badge-warning badge-pill">launch</span>
                        </div>
                        <a type class="btn mt-4 btn-warning" href="#">
                          <!---->
                          <!---->
                          <!---->
                          Learn more
          ...
          <div class="container">
            <div class="row row-grid align-items-center">
              ...
              <div class="col-md-6 order-md-1">
                <div class="pr-md-5">
                  <div
                    class="icon icon-shape mb-5 icon-lg icon-shape-success shadow rounded-circle"
                  >
            ...
            <div class="row row-grid align-items-center">
              <div class="col-md-6">
                <div class="card bg-default shadow border-0">
                  <img
                    class="card-img-top"
                    data-src="img/theme/img-1-1200x1000.jpg"
              ...
              <div class="col-md-6">
                <div class="pl-md-5">
                  <div
                    class="icon icon-shape mb-5 icon-lg icon-shape-warning shadow rounded-circle"
                  >
                ...
                <div class="card shadow-lg--hover mt-5 shadow">
                  ...
                  <div class="card-body">
                    <div class="d-flex px-3">
                      <div>
                        <div
                          class="icon icon-shape bg-gradient-success shadow rounded-circle text-white"
                        >
                          <i class="ni ni-satisfied"></i>
                        </div>
                      </div>
                ...
                <div class="card shadow-lg--hover mt-5 shadow">
                  ...
                  <div class="card-body">
                    <div class="d-flex px-3">
                      <div>
                        <div
                          class="icon icon-shape bg-gradient-warning shadow rounded-circle text-white"
                        >
            ...
            <div class="row">
              <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                <div class="px-4">
                  <img
                    ...
                    data-src="img/theme/team-1-800x800.jpg"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                    lazy="loading"
                    style="width: 200px;"
                  />
                  <div class="pt-4 text-center">
                    ...
                    <div class="mt-3">
                      <a
                        type
                        class="btn rounded-circle btn-icon-only btn-icon btn-warning"
                        href="#"
                      >
                        <!---->
              ...
              <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                <div class="px-4">
                  <img
                    class="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                    data-src="img/theme/team-3-800x800.jpg"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                    lazy="loading"
                    style="width: 200px;"
                  />
                ...
                <div class="px-4">
                  ...
                  <div class="pt-4 text-center">
                    ...
                    <div class="mt-3">
                      <a
                        type
                        class="btn rounded-circle btn-icon-only btn-icon btn-success"
                        href="#"
                      >
                        <!---->
                        <i class="fa fa-twitter"></i>
              ...
              <div class="p-5">
                <div class="row align-items-center">
                  ...
                  <div class="col-lg-3 ml-lg-auto">
                    <a
                      type
                      class="btn btn-block btn-white btn-lg"
                      href="https://www.creative-tim.com/product/vue-argon-design-system"
                    >
                      <!---->
                      <!---->
        ...
        <section class="section section-shaped my-0 overflow-hidden">
          ...
          <div class="container pt-lg pb-300">
            ...
            <div class="row row-grid mt-5">
              <div class="col-lg-4">
                <div class="icon icon-shape icon-lg bg-gradient-white shadow text-primary" round>
                  <i class="ni ni-settings"></i>
                </div>
              ...
              <div class="col-lg-8">
                <div class="card shadow bg-gradient-secondary">
                  ...
                  <div class="card-body p-lg-5">
                    ...
                    <button type="button" class="btn btn-block btn-default btn-lg" round>
                      <!---->
                      <!---->
                      <!---->
                      Send Message
                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-2 col-4">
                      ...
                      >
                        <img
                          class="img-fluid"
                          data-src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/bootstrap.jpg"
                          src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                          lazy="loading"
                        />
                      </a>
                    ...
                    <div class="col-lg-2 col-4">
                      ...
                      >
                        <img
                          ...
                          data-src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/sketch.jpg"
                          src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                          lazy="loading"
                        />
                      </a>
                    ...
                    <div class="col-lg-2 col-4">
                      ...
                      >
                        <img
                          class="img-fluid opacity-5"
                          data-src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/ps.jpg"
                          src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                          lazy="loading"
                        />
                      </a>
                    ...
                    <div class="col-lg-2 col-4">
                      ...
                      >
                        <img
                          class="img-fluid"
                          data-src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/vue.jpg"
                          src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                          lazy="loading"
                        />
                      </a>
                    ...
                    <div class="col-lg-2 col-4">
                      ...
                      >
                        <img
                          class="img-fluid opacity-5"
                          data-src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/angular.jpg"
                          src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                          lazy="loading"
                        />
                      </a>
                    ...
                    <div class="col-lg-2 col-4">
                      ...
                      >
                        <img
                          class="img-fluid opacity-5"
                          data-src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/react.jpg"
                          src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                          lazy="loading"
                        />
                      </a>
        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <div class="card card-lift--hover shadow border-0">
              <a href="#/landing" class="active router-link-active" title="Landing Page">
                <img
                  class="card-img"
                  data-src="img/theme/landing.jpg"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                  lazy="loading"
                />
              </a>
          ...
          <div class="col-md-6 mb-5 mb-lg-0">
            <div class="card card-lift--hover shadow border-0">
              <a href="#/profile" class title="Profile Page">
                <img
                  class="card-img"
                  data-src="img/theme/profile.jpg"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                  lazy="loading"
                />
              </a>
